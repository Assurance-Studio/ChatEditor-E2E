*** Settings ***
Documentation       Check "myQuickChat 12 Kind SS" NEDERLANDS vocabulary
...
*** Test Cases ***
Validate "myQuickChat 12 Kind SS" vocabulary
    ...
    Select vocabulary    name:Nederlands    name:SymbolStix     ${myQuickChat12KindSS}
...
Assertions for "myQuickChat 12 Kind SS" ENGLISH vocabulary
    ...
    # Check to see if the dictionary's name is included in the text box - myQuickChat 12 Kind SS
    RPA.Windows.Click    ${edit_mode_btn_english&nederlands}
    ${message}=    RPA.Windows.Get Text    id:65535
    Should Contain    ${message}    Het vocabulaire "myQuickChat 12 Kind SS"
    RPA.Windows.Click    id:7

    # Check to see if the dictionary's 'name' attribute is its actual name - myQuickChat 12 Kind SS
    RPA.Desktop.Press Keys    alt    b
    RPA.Windows.Click    name:Nederlands
    RPA.Windows.Click    name:SymbolStix
    ${name}=    RPA.Windows.Get Attribute    name:"myQuickChat 12 Kind SS (Huidig)"    Name
    Should Be Equal    ${name}    myQuickChat 12 Kind SS (Huidig)
