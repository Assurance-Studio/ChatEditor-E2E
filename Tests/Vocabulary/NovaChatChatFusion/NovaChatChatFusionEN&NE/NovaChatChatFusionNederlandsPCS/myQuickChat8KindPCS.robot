*** Settings ***
Documentation       Check "myQuickChat 8 Kind PCS" NEDERLANDS vocabulary
...
*** Test Cases ***
Validate "myQuickChat 8 Kind PCS" vocabulary
    ...
    Select vocabulary    name:Nederlands    name:PCS     ${myQuickChat8KindPCS}
...
Assertions for "myQuickChat 8 Kind PCS" ENGLISH vocabulary
    ...
    # Check to see if the dictionary's name is included in the text box - myQuickChat 8 Kind PCS
    RPA.Windows.Click    ${edit_mode_btn_english&nederlands}
    ${message}=    RPA.Windows.Get Text    id:65535
    Should Contain    ${message}    Het vocabulaire "myQuickChat 8 Kind PCS"
    RPA.Windows.Click    id:7

    # Check to see if the dictionary's 'name' attribute is its actual name - myQuickChat 8 Kind PCS
    RPA.Desktop.Press Keys    alt    b
    RPA.Windows.Click    name:Nederlands
    RPA.Windows.Click    name:PCS
    ${name}=    RPA.Windows.Get Attribute    name:"myQuickChat 8 Kind PCS (Huidig)"    Name
    Should Be Equal    ${name}    myQuickChat 8 Kind PCS (Huidig)
