*** Settings ***
Documentation       Check "WordPower48 Español PCS" ESPAÑOL vocabulary
...
*** Test Cases ***
Validate "WordPower48 Español PCS" vocabulary
    ...
    Select vocabulary    name:"Español de América"    name:PCS    name:WordPower     ${wordPower48EspanolPCS}
...
Assertions for "WordPower48 Español PCS" ESPAÑOL vocabulary
    ...
    # Check to see if the dictionary's name is included in the text box - WordPower48 Español PCS
    RPA.Windows.Click    ${edit_mode_btn_english&espanol}
    ${message}=    RPA.Windows.Get Text    id:65535
    Should Contain    ${message}    El vocabulario "WordPower48 Español PCS"
    RPA.Windows.Click    id:7

    # Check to see if the dictionary's 'name' attribute is its actual name - WordPower48 Español PCS
    ...
    ${name}=    RPA.Windows.Get Attribute    name:"WordPower48 Español PCS(Actual)"    Name
    Should Be Equal    ${name}    WordPower48 Español PCS(Actual)
