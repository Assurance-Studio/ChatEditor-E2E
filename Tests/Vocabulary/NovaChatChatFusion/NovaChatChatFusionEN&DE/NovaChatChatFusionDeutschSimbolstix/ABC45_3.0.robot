*** Settings ***
Documentation       Check "ABC 45 3.0" DEUTSCH vocabulary
...
*** Test Cases ***
Validate "ABC 45 3.0" vocabulary
    ...
    Select vocabulary    name:"Vorgespeicherte Vokabulare"    name:"ABC-Programme"     ${ABC45_3.0}
...
Assertions for "ABC 45 3.0" DEUTSCH vocabulary
    ...
    # Check to see if the dictionary's name is included in the text box - ABC 45 3.0
    RPA.Windows.Click    ${edit_mode_btn_english&deutsch}
    ${message}=    RPA.Windows.Get Text    id:65535
    Should Contain    ${message}    "ABC 45 3.0" ist ein Original vokabular
    RPA.Windows.Click    id:7

    # Check to see if the dictionary's 'name' attribute is its actual name - ABC 45 3.0
    RPA.Desktop.Press Keys    alt    b
    RPA.Windows.Click    name:"Vorgespeicherte Vokabulare"
    RPA.Windows.Click    name:"ABC-Programme"
    ${name}=    RPA.Windows.Get Attribute    name:"ABC 45 3.0 (aktuell)"    Name
    Should Be Equal    ${name}    ABC 45 3.0 (aktuell)
