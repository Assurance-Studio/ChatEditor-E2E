*** Settings ***
Documentation       Check "MultiFoXX 24 1.1" DEUTSCH vocabulary
...
*** Test Cases ***
Validate "MultiFoXX 24 1.1" vocabulary
    ...
    Select vocabulary    name:"Vorgespeicherte Vokabulare"    name:"MultiFoXX-Programme"     ${multiFoXX24_1.1}
...
Assertions for "MultiFoXX 24 1.1" DEUTSCH vocabulary
    ...
    # Check to see if the dictionary's name is included in the text box - MultiFoXX 24 1.1
    RPA.Windows.Click    ${edit_mode_btn_english&deutsch}
    ${message}=    RPA.Windows.Get Text    id:65535
    Should Contain    ${message}    "MultiFoXX 24 1.1" ist ein Original vokabular
    RPA.Windows.Click    id:7

    # Check to see if the dictionary's 'name' attribute is its actual name - MultiFoXX 24 1.1
    RPA.Desktop.Press Keys    alt    b
    RPA.Windows.Click    name:"Vorgespeicherte Vokabulare"
    RPA.Windows.Click    name:"MultiFoXX-Programme"
    ${name}=    RPA.Windows.Get Attribute    name:"MultiFoXX 24 1.1 (aktuell)"    Name
    Should Be Equal    ${name}    MultiFoXX 24 1.1 (aktuell)
