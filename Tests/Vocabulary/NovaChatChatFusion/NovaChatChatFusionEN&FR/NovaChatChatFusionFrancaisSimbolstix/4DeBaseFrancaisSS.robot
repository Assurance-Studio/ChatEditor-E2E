*** Settings ***
Documentation       Check "4 de base français SS" FRANCAISE vocabulary
...
Assertions for "4 de base français SS" FRANCAISE vocabulary
    ...
    # Check to see if the dictionary's name is included in the text box - 4 de base français SS
    RPA.Windows.Click    ${edit_mode_btn_english&français}
    ${message}=    RPA.Windows.Get Text    id:65535
    Should Contain    ${message}    Le vocabulaire "4 de base français SS"
    RPA.Windows.Click    id:7

    # Check to see if the dictionary's 'name' attribute is its actual name - 4 de base français SS
    RPA.Desktop.Press Keys    alt    b
    RPA.Windows.Click    name:"Canadienne-Française"
    RPA.Windows.Click    name:SymbolStix
    ${name}=    RPA.Windows.Get Attribute    name:"4 de base français SS (Courant)"    Name
    Should Be Equal    ${name}    4 de base français SS (Courant)
