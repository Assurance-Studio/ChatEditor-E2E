...
Validate "sintaxis 4x5 English SS" vocabulary
    ...
    Select vocabulary    name:English    name:SymbolStix    NONE    ${sintaxis4x5EnglishSS}

Assertions
    Check to see if the user exist

    # Check to see if the dictionary's name is included in the text box - sintaxis 4x5 English SS
    ...
    # Check to see if the dictionary's 'name' attribute is its actual name - sintaxis 4x5 English SS
