...
Validate "myQuickChat 12 Child SS" vocabulary
    ...
    Select vocabulary    name:English    name:SymbolStix    NONE    ${myQuickChat12ChildSS}
...
Assertions
    ...
    # Check to see if the dictionary's name is included in the text box - myQuickChat 12 Child SS
    RPA.Windows.Click    ${edit_mode_btn}
    ${message}=    RPA.Windows.Get Text    id:65535
    Should Contain    ${message}    The vocabulary "myQuickChat 12 Child SS"
    RPA.Windows.Click    id:7

    # Check to see if the dictionary's 'name' attribute is its actual name - myQuickChat 12 Child SS
