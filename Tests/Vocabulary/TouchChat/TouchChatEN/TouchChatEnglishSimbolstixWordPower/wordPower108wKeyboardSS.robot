...
Validate "WordPower108 w Keyboard SS" vocabulary
    ...
    Select vocabulary    name:English    name:SymbolStix    name:WordPower    ${wordPower108wKeyboardSS}
...
Assertions
    ...
    Click On Button With Text    ${text}    TouchChat\\TouchChatEnglish\\wordPower108wKeyboardSS\\people.png    0.6

    Check to see if the user exist

    # Check to see if the dictionary's name is included in the text box - WordPower108 w Keyboard SS
    RPA.Windows.Click    ${edit_mode_btn}
    ${message}=    RPA.Windows.Get Text    id:65535
    Should Contain    ${message}    The vocabulary "WordPower108 w Keyboard SS"
    RPA.Windows.Click    id:7

    # Check to see if the dictionary's 'name' attribute is its actual name - WordPower108 w Keyboard SS
